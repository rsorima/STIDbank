<style>
    .modal-body .current-password, .modal-body .new-password ,.modal-body .confirm-password{
        width: 45%;
    }

    .cp-error-message, .gr-error-message{
        color: red;
    }
</style>
            ...
            <div class="modal-content">
                ...
                <div class = "modal-body">
                    <div class="form-group"> 
                        ...
                        <input type="text" class="form-control" id="txtGroup" placeholder="Enter Group Name*">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" id="btnSubmitGroup">Submit</button> 
