        ...
        <footer>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <ul class="list-inline social-buttons">
                                <li>
                                    <a href="https://www.facebook.com/sti.edu/"><i class="fa fa-facebook-f"></i></a>
                                </li>
                                <li>
                                    <a href="https://twitter.com/sticollege"><i class="fa fa-twitter"></i></a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/stidotedu/"><i class="fa fa-instagram"></i></a>
                                </li>
                                <li>
                                    <a href="https://www.youtube.com/user/STIdotEdu"><i class="fa fa-youtube"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container-fluid container-foot">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h6 class="content">STI EDUCATIONAL PROJECT</h6>
                            <h6 class="content">Copyright © <a class="a-thesis" style="color: white;">Thesis Data Bank</a></h6>
                        </div>
                    </div>
                </div>
            </div>
