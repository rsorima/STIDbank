<?php
    ...
    $get_group = "SELECT count(gu.group_id) as totalStudents ,g.group_id as group_id, g.group_name as group_name, g.adviser_id as adviser_id, g.branchid as branch_id from groups g left join group_users gu on g.group_id = gu.group_id where g.branchid = '$branchid' group by g.group_name";
