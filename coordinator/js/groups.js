$(document).ready(function(){
    ...
    $('#btnSubmitGroup').click(function(){
        ...
        {
            $.ajax({
                url: "php/add-group.php?name="+groupName,
                type: "GET",
                dataType: "json",
                success: function(data){
                    alert(data.message);
            ...
            success: function(data){
                for(index in data){
                    $('.selectStudent').append(
                        "<option value='"+data[index].userid+"'>"+data[index].lastname+", "+data[index].firstname+"</option>"
                    );
                }
            }
        });
    ...
    function getGroupUsers(groupId){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                for(index in data){
                    $('.membersList').append(
                        "<li class='list-group-item'>"+data[index].lastname+", "+data[index].firstname+"<a style='float:right' groupUserId='"+data[index].groupUserId+"' groupId = '"+groupId+"' class='removeMember'>remove</a></li>"
                    );
                }
            }
        });
